...
RiboseQC_analysis(annotation_file="~/Desktop/Ribo_example/Araport11_20220629.gtf_Rannot",bam_files = "~/Desktop/Ribo_example/star_ribo_NEB1_h1M_Aligned.sortedByCoord.out.bam",report_file = "star_ribo_NEB1_h1M_rm_Contam5.html",write_tmp_files = F)
```
...
load("~/Desktop/New_Riboseq/star_ribo_NEB1_h1M_Aligned.sortedByCoord.out.bam_results_RiboseQC")
